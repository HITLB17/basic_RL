        ...
        with tf.variable_scope(scope):
            ...
            with tf.variable_scope('a'):
                actions = tf.layers.dense(net,
                                          ...
                                          name='a',
                                          trainable=trainable)
                scaled_a = tf.multiply(actions, self.action_bound, name='scaled_a') # scaled output to -action_bound to action_bound
        return scaled_a
...
# they are actually connected to each other, detail can be seen in tensorboard or in this picture
